...
class Dashboard_log extends CI_Controller {
	...
	*/
	...
	public function index()
	{
		...
		if($this->session->userdata('user_type')=='3'){
				...
				$data['total_countrys'] = $this->logbook_model->total_countrys_byUser();
				$data['last_five_qsos'] = $this->logbook_model->get_last_qsos_byuser('11');
		}else{
				// Store info

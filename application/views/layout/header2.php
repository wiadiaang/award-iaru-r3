				...
				<div class="left">
					...
					<div>
						...
						<ul>
							...
							<li class="bLogin"><a target="_blank" href="http://awards-iaru-r3.org/index.php/user/login">Login</a></li>
							...
							<li><a href="<?php echo site_url('home/award_summary');?>">Award summary</a></li>

						...
						?>
							 ...
							 <tr>
								...
								<?php
									...
									if($basic->total >= '5'){
										// echo '<a href='.$url.'/search2/cek_awards_bronze_all/'.$callsign.'>Link Download Basic Mixed</a>';
							...
							if($silver->total >= '10'){
								// echo '<a href='.$url.'/search2/cek_awards_silver_all/'.$callsign.'>Link Download Silver Mixed</a>';
							...
							<tr>
								...
								order by a.COL_MODE, a.COL_BAND")->row();
									...
									if($gold->total >= '15'){
										  //	echo '<a href='.$url.'/search2/cek_awards_gold_all/'.$callsign.'>Link Download Gold Mixed</a>';

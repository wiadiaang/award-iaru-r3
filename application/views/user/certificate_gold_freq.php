...
<html>
	...
	<body>
		...
		<div class="qsl">
			...
			<img class="center" src="<?php echo base_url(); ?>assets/images/The_IARU_Region_3_50th_Anniversary_Award_Gold.jpg"/>
			...
			<div class="data">
				...
				<div class="data-nama">
					...
					<?php
					$filearr = explode(".",$freq);
					$filewithoutextension = $filearr[0];  
				?>
				<span><?php echo strtoupper($filewithoutextension); ?> MHz <?php echo strtoupper($endorsment); ?></span>
